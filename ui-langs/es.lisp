...
(set-ui-language
 ...
 :ask-save-dict
 "¿Quieres guardar los cambios hechos en tu diccionario durante esta sesión?"
 :aspect
 "Aspecto"
 :aspect-listening
 "Escucha"
...
El ítem tendrá por defecto la forma [DEFAULT-FORM](arg). Si el ítem ya existe
en el diccionario, este comando no tiene efectos."
 :cmd-add-s
 "Añadir un nuevo ítem al diccionario."
 :cmd-audio-l
 "Busca bases de datos Shtooka, elige y reproduce algún archivo de audio
relevante para [TEXT](arg). Puedes usar [Ctrl-o](typ) para repetir la
última consulta de audio"
 :cmd-audio-s
...
palabras que coincidan con las letras de la palabra ingresada serán reveladas.
Este ejercicio toma [WORDS](arg) palabras de tu diccionario."
 :cmd-crosswd-s
 "Ejercicio de crucigrama."
 :cmd-dict-l
 "Imprime información sobre el diccionario. Si el argumento [PREFIX](arg)
es dado, muestra información detallada acerca de cada ítem del diccionario
cuya forma (indizada en cero) por defecto comience con el prefijo dado.
En caso contrario imprime información acerca de todo el diccionario."
 :cmd-dict-s
...
seleccionada en [FORM-INDEX](arg) es reemplazada por [NEW-FORM](arg).
Para obtener información acerca de la forma de los índices escriba [forms](cmd)
comando."
 :cmd-eform-s
 "Cambiar la forma de un ítem del diccionario."
 :cmd-etrans-l
 "Edita un ítem del diccionario cambiando su traducción. El ítem a cambiar es
es identificado por [TYPE](arg) y [DEFAULT-FORM](arg)."
 :cmd-etrans-s
 "Cambiar la traducción de un ítem del diccionario."
 :cmd-forms-l
 "Imprime una tabla con las formas indexadas de un [LEXEME](arg) dado. También
puedes obtener una lista de todos los lexemas con el comando [lexemes](cmd)."
 :cmd-forms-s
 "Imprimir formas de un lexema."
 :cmd-help-l
 "Cuando es invocado sin argumentos, imprime información sobre todos los comandos
disponibles. Cuando el argumento [COMMAND](arg) es dado, imprime una descripción
detallada del comando en particular."
 :cmd-help-s
 "Imprimir información sobre comandos."
 :cmd-history-l
 "Imprime el historial de sesión actual. El argumento indica cuántos ítems del
historial deben ser impresos."
 :cmd-history-s
 "Imprimir historial."
 :cmd-lang-l
...
te gustaría alcanzar."
 ...
 :cmd-query-l
 "Muestra información (y su traducción) acerca de una palabra
[WORD](arg) dada."
 :cmd-query-s
...
identificado por su [TYPE](arg) y [DEFAULT-FORM](arg)."
 ...
 :cmd-reset-l
 "Reestablece el progreso de un ítem en particular del diccionario. El
ítem es identificado por sus [TYPE](arg) y [DEFAULT-FORM](arg)."
 :cmd-reset-s
...
[PROGRESS](arg) indica qué porcentaje de progreso te gustaría alcanzar."
 ...
 "[No se pudo](err) añadir [~](typ) [~](arg), ya está presente en tu diccionario."
 :dict-item-learned
 ...
 "Ingrese la palabra letra por letra (pista: tienes todas las letras
de la palabra en la línea de comandos, pero están desordenadas):"
 :exercise-crossword
...
[~](arg). En Шτookωвiнα ingresas comandos y sus argumentos para hacer
que varias cosas sucedan. De esta forma puedes añadir palabras a tu
diccionario y editarlas, realizar varios ejercicios con estas palabras,
y otras cosas interesantes. Cada comando está minuciosamente documentado,
así que la primera cosa que deberías aprender acerca de este entorno es
cómo descubrir nuevos comandos y obtener descripción del comando en el
que estás interesado. El comando [help](cmd) viene bien aquí. Intenta
escribirlo ahora sin argumentos."
 :tutorial-1
 "[Genial!](hdr) Como puedes ver hay bastantes comandos disponibles en
Шτookωвiнα. Elije alguno y escribe el comando [help](cmd) con el nombre
del comando como argumento, por ejemplo [help](cmd) [help](arg)."
 :tutorial-2
...
cuatro argumentos! Piensa qué darle al comando [add](cmd) y añade la
primera palabra a tu diccionario."
 :tutorial-3
 "[Bien!](hdr) Ahora añade [11](arg) más palabras de diferentes tipos.
Deberías tener [12](arg) palabras en tu diccionario para continuar con
este tutorial. Fíjate que puedes obtener algunas estadísticas con ayuda
del comando [dict](cmd). Este comando puede ser usado para mostrar
estadísticas sobre ciertas palabras en particular que tienen un prefijo
en común. Dale ese prefijo como primer argumento al comando [dict](cmd)
para usar esta funcionalidad."
 :tutorial-4
 "[12 palabras deberían bastar](hdr) para comenzar nuestro entrenamiento.
Шτookωвiнα tiene algunos ejercicios para practicar diferentes aspectos
del reconocimiento de palabras: [traducción](typ), [escritura](typ), y
...
Puedes enseñarle cómo buscar la definición y/o traducción de una palabra
en diccionarios en línea. Puedes también reprogramar Шτookωвiнα añadiendo
algo de código en tu archivo de configuración. Incluso puedes definir
nuevos comandos, etc. Este tutorial te ha mostrado muy básicos comandos y
temo que va a terminar. Para salir del entorno interactivo escribe
...
dos letras, por ejemplo [\"en\"](arg) para Inglés."
 :wizard-ui-lang-bad
 "El input [\"~\"](arg) no representa ningún idioma definido, intenta
de nuevo."
 :wizard-ui-lang-ok
