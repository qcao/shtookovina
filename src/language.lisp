...
concatenation of all possible combinations of «form aspects» supplied
...
(defun forms-number (lexeme)
  "Return number of forms that LEXEME has in the actual language. If there
is no such lexeme in the language, return NIL."
  (awhen (get-lexeme lexeme)
    (length (forms it))))

(defun form-name (lexeme &optional (form 0))
  "Return name of specified FORM (integer) of LEXEME in actual language. If
